...
namespace Quest.MPDW.Customer
{
    public class ContractsController : CustomerBaseController
    {
        ...
        public ActionResult Index(BaseUserSessionViewModel baseUserSessionViewModel)
        {
             ...
             * Return view.
             *---------------------------------------------------------------------------------------------------------------------------------*/
            CustomerContractsListViewModel customerContractsListViewModel = new CustomerContractsListViewModel(this.UserSession, baseUserSessionViewModel);
            return View(customerContractsListViewModel);
        }
        [HttpGet]
        public ActionResult List(BaseUserSessionViewModel baseUserSessionViewModel)
        {
             ...
             *---------------------------------------------------------------------------------------------------------------------------------*/
            // TODO.
            CustomerContractsListViewModel customerContractsListViewModel = new CustomerContractsListViewModel(this.UserSession);

            /*----------------------------------------------------------------------------------------------------------------------------------
             * Return view
             *---------------------------------------------------------------------------------------------------------------------------------*/
            status = new questStatus(Severity.Warning, "Not implemented yet");
            customerContractsListViewModel.questStatus = status;
            return Json(customerContractsListViewModel, JsonRequestBehavior.AllowGet);
        }
