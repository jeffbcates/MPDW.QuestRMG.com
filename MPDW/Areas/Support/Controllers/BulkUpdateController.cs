...
{
    public class BulkUpdateController : SupportBaseController
    {
        #region Declarations
        /*==================================================================================================================================
         * Declarations
        ...
        public ActionResult Index(BaseUserSessionViewModel baseUserSessionViewModel)
        {
             ...
             * Return view.
             *---------------------------------------------------------------------------------------------------------------------------------*/
            BulkUpdateViewModel bulkUpdateViewModel = new BulkUpdateViewModel(this.UserSession, baseUserSessionViewModel);
            return View(bulkUpdateViewModel);
        }
