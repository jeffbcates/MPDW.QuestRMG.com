...
{
    public class RequisitionsController : SearchBaseController
    {
        #region Declarations
        /*==================================================================================================================================
         * Declarations
        ...
        public ActionResult Index(BaseUserSessionViewModel baseUserSessionViewModel)
        {
             ...
             * Return view.
             *---------------------------------------------------------------------------------------------------------------------------------*/
            RequisitionsSearchViewModel requisitionsSearchViewModel = new RequisitionsSearchViewModel(this.UserSession, baseUserSessionViewModel);
            return View(requisitionsSearchViewModel);
        }
