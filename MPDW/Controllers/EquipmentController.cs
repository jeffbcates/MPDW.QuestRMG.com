...
{
    public class EquipmentController : EquipmentBaseController
    {
        #region Declarations
        /*==================================================================================================================================
         * Declarations
        ...
        public ActionResult Index(BaseUserSessionViewModel baseUserSessionViewModel)
        {
             ...
             * Return view.
             *---------------------------------------------------------------------------------------------------------------------------------*/
            EquipmentsListViewModel equipmentsListViewModel = new EquipmentsListViewModel(this.UserSession, baseUserSessionViewModel);
            return View(equipmentsListViewModel);
        }
        [HttpGet]
        public ActionResult List(BaseUserSessionViewModel baseUserSessionViewModel)
        {
            ...
            /*----------------------------------------------------------------------------------------------------------------------------------
             * Get list of Equipments for this user.
             *---------------------------------------------------------------------------------------------------------------------------------*/
            // TODO.
